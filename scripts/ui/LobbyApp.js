 ...
 * at module scope (before init) causes a silent crash in Foundry v13.
 */
...
export let LobbyApp = null;

Hooks.once("init", () => {
  const { ApplicationV2, HandlebarsApplicationMixin } = foundry.applications.api;

  LobbyApp = class LobbyApp extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  console.log("The Degenerate Inn | LobbyApp class registered.");
});
